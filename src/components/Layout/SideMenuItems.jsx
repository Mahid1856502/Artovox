...
const CORPORATE_MENU = [
  {
    key: PATH.CORPORATE_AND_INDIVIDUAL_DASHBOARD,
    icon:  (
      <img
    ...
    label: (
      <Link className="primary-blue-color" to={PATH.CORPORATE_AND_INDIVIDUAL_DASHBOARD}>
        Dashboard
      </Link>
    ),
  },
  {
    key: PATH.CORPORATE_AND_INDIVIDUAL_PROJECTS,
    icon:  (
      <img
    ...
    label: (
      <Link className="primary-blue-color" to={PATH.CORPORATE_AND_INDIVIDUAL_PROJECTS}>
        Projects
      </Link>
    ),
  },
